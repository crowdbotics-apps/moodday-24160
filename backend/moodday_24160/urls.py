"""moodday_24160 URL Configuration
...
admin.site.site_header = "Moodday"
admin.site.site_title = "Moodday Admin Portal"
admin.site.index_title = "Moodday Admin"

# swagger
api_info = openapi.Info(
    title="Moodday API",
    default_version="v1",
    description="API documentation for Moodday App",
)
